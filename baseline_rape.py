...
sc[np.where(sc[:,5]=='第五真叶'),5] = 3
sc[np.where(sc[:,5]=='移栽'),5] = 4
sc[np.where(sc[:,5]=='开盘'),5] = 5
sc[np.where(sc[:,5]=='现蕾'),5] = 6
sc[np.where(sc[:,5]=='抽薹'),5] = 7
sc[np.where(sc[:,5]=='开花'),5] = 8
...
np.save('./rape_res.npy',res)

res = np.load('./rape_res.npy')
